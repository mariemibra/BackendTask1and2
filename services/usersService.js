...
const getAllUsers = async (query) => {
    try {
         ...
         * 2 page => next 10 skip 10 limit 10 | (2-1)*10 = 10 | (2-1)*10 = 10
         * 3 page => next 10 skip 20 limit 10 | (3-1)*10 = 20 | (3-1)*10 = 20
         */
...
const deleteUser = async (id) => {
    try {
        // if user exist , return user then delte it , if it doesn't exist will return null
...
const validateCredentails = async ({ email, password }) => {
    try {
        ...
        // compare hashed Password with the incoming passowrd using bcrypt.compare
